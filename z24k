...
pause_enter() {
	read_tty "Enter ¶‡T—¶‡T¨¶·¶œ ¶‡T◊¶·¶¬¶‡T’¶‡T—¶‡T’¶‡T¨¶‡T¶¶‡T¶¶‡¶≈¶‡T—¶·¶œ" _
}
...
do_install() {
	...
	if ! ensure_autopick_lists; then
		echo -e "${yellow}¶‡¶Œ¶‡T◊¶‡T—¶·¶√¶‡T‘¶‡T— ¶‡¶≈¶‡T¶ ¶‡¶≈¶‡T-¶‡Úƒ÷¶‡T—¶‡T¶¶‡¶≈¶·Ú¿¶ ¶‡T—¶‡T¨¶‡T— ¶‡T◊¶·T”¶·¶√¶·Ú¿⁄¶·Ú¿¶¶‡T¶ ¶‡T◊¶‡T’¶·¶√¶‡T¨¶‡T¶ ¶‡T’¶‡T-¶‡¶≈¶‡T’¶‡¶∆¶‡T¨¶‡T¶¶‡¶≈¶‡T—¶·¶œ. ¶‡T“¶‡¶∆¶·Ú¿⁄¶‡T’¶‡T◊¶‡T’¶‡T—¶‡T-¶‡T’¶·¶¬ ¶‡T-¶·T”¶‡T—¶‡T¶¶·Ú¿⁄ ¶‡T◊¶·¶¬¶‡T’¶‡T◊¶·T”¶·Ú¿-¶‡T¶¶‡¶≈.${plain}"
	fi
...
do_uninstall() {
	echo -e "${yellow}¶‡¶»¶‡T—¶‡T-¶‡T¨¶‡T¶¶‡¶≈¶‡T—¶‡T¶ zapret2 ¶‡T— ¶·¶√¶‡T¶¶·¶¬¶‡¶∆¶‡T—¶·¶√¶‡T’¶‡¶∆...${plain}"
	if [ -x "$SERVICE" ]; then
		"$SERVICE" stop || true
	fi
	...
	rm -f /opt/bin/z24k
	rm -rf "$INSTALL_DIR"
	echo -e "${green}¶‡¶»¶‡T—¶‡T-¶‡T¨¶‡T¶¶‡¶≈¶‡T—¶‡T¶ ¶‡T¨¶‡T-¶‡¶∆¶‡T¶¶·¶¬¶·Ú¬Ï¶‡T¶¶‡¶≈¶‡T’.${plain}"
	pause_enter
}
...
apply_preset() {
	name="$1"
	opt="$2"
	echo -e "${cyan}œËÏÂÌÂÌËÂ ÒÚ‡ÚÂ„ËË: ${green}${name}${plain}"
	ensure_split_hostlists
	set_opt_block "$opt"
	set_kv NFQWS2_ENABLE 1
	set_kv Z24K_PRESET "$name"
	restart_service
	echo -e "${green}√ÓÚÓ‚Ó.${plain}"
	pause_enter
}
...
auto_pick_strategy() {
	...
	if [ "$list_key" = "rkn" ]; then
		...
		if [ -z "$domain" ]; then
			echo -e "${yellow}¶‡¶Œ¶‡T◊¶‡T—¶·¶√¶‡T’¶‡T‘ ¶‡T◊¶·T”¶·¶√¶·Ú¿⁄¶‡T’¶‡Úƒ÷: $list_file${plain}"
			pause_enter
			return
		fi
	fi
	...
	echo -e "${cyan}¶‡Tﬂ¶‡T’¶‡T—¶‡T-¶‡T’¶·¶¬ ¶·¶√¶·Ú¿⁄¶·¶¬¶‡T-¶·Ú¿⁄¶‡T¶¶‡T÷¶‡T—¶‡T— ¶‡T—¶‡T¨¶·¶œ ${green}${label}${plain} (${domain})"
	log "¶‡Ú¿¶¶‡T’¶‡T÷ blockcheck2: $logfile"
	: > "$logfile"
	scanlevel=""
	while :; do
		...
		if [ -n "$found_tls" ] || [ -n "$found_quic" ]; then
			...
			echo -e "${green}¶‡¶Œ¶·Ú¿⁄¶·¶¬¶‡T-¶·Ú¿⁄¶‡T¶¶‡T÷¶‡T—¶·¶œ ¶‡T◊¶·¶¬¶‡T—¶‡Tÿ¶‡T¶¶‡¶≈¶‡T¶¶‡¶≈¶‡T- ¶‡¶∆¶·¶¬¶‡T¶¶‡Tÿ¶‡T¶¶‡¶≈¶‡¶≈¶‡T’. ¶‡Tﬂ¶·¶¬¶‡T’¶‡¶∆¶‡T¶¶·¶¬¶·¶ ¶·Ú¿⁄¶‡T¶ ¶‡T—¶‡T’¶·¶√¶·Ú¿⁄¶·T”¶‡T◊¶‡¶≈¶‡T’¶·¶√¶·Ú¿⁄¶·¶ .${plain}"
			read_tty "¶‡¶Œ¶‡T’¶·Ú¿Ê¶·¶¬¶‡T-¶‡¶≈¶‡T—¶·Ú¿⁄¶·¶  (s), ¶‡T◊¶·¶¬¶‡T’¶‡T—¶‡T’¶‡T¨¶‡T¶¶‡T—¶·Ú¿⁄¶·¶  (c) ¶‡T—¶‡T¨¶‡T— ¶‡¶∆¶·Ú¿¶¶‡Úƒ÷¶·Ú¿⁄¶‡T— (q)? " choice
			case "$choice" in
				s|S)
	...
	if [ -z "$tls_strat" ] && [ -z "$quic_strat" ]; then
		echo -e "${yellow}¶‡¶Œ¶·Ú¿⁄¶·¶¬¶‡T-¶·Ú¿⁄¶‡T¶¶‡T÷¶‡T—¶·¶œ ¶‡¶≈¶‡T¶ ¶‡¶≈¶‡T-¶‡Úƒ÷¶‡T—¶‡T¶¶‡¶≈¶‡T-. ¶‡Ú¿¶¶‡T’¶‡T÷: $logfile${plain}"
		pause_enter
		return
	fi
	...
	echo -e "${green}¶‡¶Œ¶·Ú¿⁄¶·¶¬¶‡T-¶·Ú¿⁄¶‡T¶¶‡T÷¶‡T—¶·¶œ ¶‡T◊¶·¶¬¶‡T—¶‡Tÿ¶‡T¶¶‡¶≈¶‡T¶¶‡¶≈¶‡T- ¶‡T—¶‡T¨¶·¶œ $label.${plain}"
	pause_enter
}
...
toggle_nfqws2() {
	...
	if [ "$cur" = "1" ]; then
		...
		echo -e "${yellow}NFQWS2 ¶‡T’¶·Ú¿⁄¶‡T‘¶‡T¨¶·¶À¶·Ú¿·¶‡T¶¶‡¶≈.${plain}"
	else
		set_kv NFQWS2_ENABLE 1
		echo -e "${green}NFQWS2 ¶‡¶∆¶‡T‘¶‡T¨¶·¶À¶·Ú¿·¶‡T¶¶‡¶≈.${plain}"
	fi
	restart_service
	pause_enter
}
...
sync_category_lists() {
	...
	echo -e "${yellow}¶‡¶Œ¶‡T◊¶‡T—¶·¶√¶‡T’¶‡T‘ $LISTS_DIR/$file ¶‡¶≈¶‡T¶ ¶‡¶≈¶‡T-¶‡Úƒ÷¶‡T—¶‡T¶¶‡¶≈. ¶‡Ú¿›¶‡T’¶‡T‘¶‡T-¶·Ú¿·¶‡T‘¶‡T- ¶‡T’¶·Ú¿⁄¶‡T‘¶‡T¨¶·¶À¶·Ú¿·¶‡T¶¶‡¶≈¶‡T-.${plain}"
	done
}
...
check_access() {
	...
	if curl --tls-max 1.2 --max-time 2 -s -o /dev/null "$url"; then
		echo -e "${green}¶‡Ú¿‚¶·¶√¶·Ú¿⁄¶·¶  ¶‡T’¶·Ú¿⁄¶‡¶∆¶‡T¶¶·Ú¿⁄ ¶‡T◊¶‡T’ TLS 1.2.${plain}"
	else
		echo -e "${yellow}¶‡T‹¶‡T¶¶·Ú¿⁄ ¶‡T’¶·Ú¿⁄¶‡¶∆¶‡T¶¶·Ú¿⁄¶‡T- ¶‡T◊¶‡T’ TLS 1.2.${plain}"
	fi
	if curl --tlsv1.3 --max-time 2 -s -o /dev/null "$url"; then
		echo -e "${green}¶‡Ú¿‚¶·¶√¶·Ú¿⁄¶·¶  ¶‡T’¶·Ú¿⁄¶‡¶∆¶‡T¶¶·Ú¿⁄ ¶‡T◊¶‡T’ TLS 1.3.${plain}"
	else
		echo -e "${yellow}¶‡T‹¶‡T¶¶·Ú¿⁄ ¶‡T’¶·Ú¿⁄¶‡¶∆¶‡T¶¶·Ú¿⁄¶‡T- ¶‡T◊¶‡T’ TLS 1.3.${plain}"
	fi
}
...
auto_pick_category() {
	...
	if ! need_cmd curl; then
		echo -e "${yellow}curl ¶‡¶≈¶‡T¶ ¶‡¶≈¶‡T-¶‡Úƒ÷¶‡T—¶‡T¶¶‡¶≈. ¶‡T“¶‡¶∆¶·Ú¿⁄¶‡T’¶‡T◊¶‡T’¶‡T—¶‡T-¶‡T’¶·¶¬ ¶‡T◊¶·¶¬¶‡T’¶‡T◊¶·T”¶·Ú¿-¶‡T¶¶‡¶≈ ¶‡T—¶‡T¨¶·¶œ ${label}.${plain}"
		return 1
	fi

	mkdir -p "$TMP_DIR"
	if [ ! -s "$CATEGORIES_FILE" ]; then
		echo -e "${yellow}¶‡T‰¶‡T-¶‡Úƒ÷¶‡T¨ ¶‡T‘¶‡T-¶·Ú¿⁄¶‡T¶¶‡T÷¶‡T’¶·¶¬¶‡T—¶‡Úƒ÷ ¶‡¶≈¶‡T¶ ¶‡¶≈¶‡T-¶‡Úƒ÷¶‡T—¶‡T¶¶‡¶≈. ¶‡T“¶‡¶∆¶·Ú¿⁄¶‡T’¶‡T◊¶‡T’¶‡T—¶‡T-¶‡T’¶·¶¬ ¶‡T◊¶·¶¬¶‡T’¶‡T◊¶·T”¶·Ú¿-¶‡T¶¶‡¶≈ ¶‡T—¶‡T¨¶·¶œ ${label}.${plain}"
		return 0
	fi
	mode=$(get_category_value "$section" "filter_mode")
	hostlist=$(get_category_value "$section" "hostlist")
	...
	if [ -n "$filter_file" ] && [ ! -s "$LISTS_DIR/$filter_file" ]; then
		echo -e "${yellow}¶‡¶Œ¶‡T◊¶‡T—¶·¶√¶‡T’¶‡T‘ $LISTS_DIR/$filter_file ¶‡¶≈¶‡T¶ ¶‡¶≈¶‡T-¶‡Úƒ÷¶‡T—¶‡T¶¶‡¶≈ ¶‡T—¶‡T¨¶‡T— ¶‡T◊¶·T”¶·¶√¶·Ú¿⁄¶‡T’¶‡Úƒ÷. ¶‡T“¶‡¶∆¶·Ú¿⁄¶‡T’¶‡T◊¶‡T’¶‡T—¶‡T-¶‡T’¶·¶¬ ¶‡T◊¶·¶¬¶‡T’¶‡T◊¶·T”¶·Ú¿-¶‡T¶¶‡¶≈ ¶‡T—¶‡T¨¶·¶œ ${label}.${plain}"
		return 0
	fi
	...
	if [ ! -s "$ini_file" ]; then
		echo -e "${yellow}¶‡T‰¶‡T-¶‡Úƒ÷¶‡T¨ ¶·¶√¶·Ú¿⁄¶·¶¬¶‡T-¶·Ú¿⁄¶‡T¶¶‡T÷¶‡T—¶‡Úƒ÷ ¶‡¶≈¶‡T¶ ¶‡¶≈¶‡T-¶‡Úƒ÷¶‡T—¶‡T¶¶‡¶≈. ¶‡T“¶‡¶∆¶·Ú¿⁄¶‡T’¶‡T◊¶‡T’¶‡T—¶‡T-¶‡T’¶·¶¬ ¶‡T◊¶·¶¬¶‡T’¶‡T◊¶·T”¶·Ú¿-¶‡T¶¶‡¶≈ ¶‡T—¶‡T¨¶·¶œ ${label}.${plain}"
		return 0
	fi
	if [ ! -s "$BLOBS_FILE" ]; then
		echo -e "${yellow}¶‡T‰¶‡T-¶‡Úƒ÷¶‡T¨ blobs ¶‡¶≈¶‡T¶ ¶‡¶≈¶‡T-¶‡Úƒ÷¶‡T—¶‡T¶¶‡¶≈. ¶‡T‡¶‡T¶¶‡T¨¶·T”¶‡T¨¶·¶ ¶·Ú¿⁄¶‡T-¶·Ú¿⁄¶·Ú¿¶ ¶‡T-¶‡¶∆¶·Ú¿⁄¶‡T’¶‡T◊¶‡T’¶‡T—¶‡T-¶‡T’¶·¶¬¶‡T- ¶‡Tÿ¶‡T’¶‡T÷¶·T”¶·Ú¿⁄ ¶‡T-¶·Ú¿¶¶·Ú¿⁄¶·¶  ¶‡¶≈¶‡T¶¶‡T‘¶‡T’¶·¶¬¶·¶¬¶‡T¶¶‡T‘¶·Ú¿⁄¶‡¶≈¶·Ú¿¶.${plain}"
	fi
	...
	if [ "$count" -le 0 ]; then
		echo -e "${yellow}¶‡¶Œ¶‡T◊¶‡T—¶·¶√¶‡T’¶‡T‘ ¶·¶√¶·Ú¿⁄¶·¶¬¶‡T-¶·Ú¿⁄¶‡T¶¶‡T÷¶‡T—¶‡Úƒ÷ ¶‡T◊¶·T”¶·¶√¶·Ú¿⁄ ¶‡T—¶‡T¨¶·¶œ ${label}.${plain}"
		return 1
	fi
...
show_status() {
	...
	echo -e "${cyan}--- ¶‡¶Œ¶·Ú¿⁄¶‡T-¶·Ú¿⁄¶·T”¶·¶√ ---${plain}"
	echo "¶‡¶»¶·¶√¶·Ú¿⁄¶‡T-¶‡¶≈¶‡T’¶‡¶∆¶‡T¨¶‡T¶¶‡¶≈¶‡T’: $installed"
	echo "¶‡Tﬂ¶·¶¬¶‡T¶¶·¶√¶‡T¶¶·Ú¿⁄: $preset"
...
menu() {
	safe_clear
	echo -e "${cyan}--- z24k ¶‡Tÿ¶‡T¶¶‡¶≈¶·¶À ---${plain}"
	show_status
	echo ""
	menu_item "1" "¶‡¶»¶·¶√¶·Ú¿⁄¶‡T-¶‡¶≈¶‡T’¶‡¶∆¶‡T‘¶‡T-/¶‡T€¶‡T-¶‡¶≈¶‡T’¶‡¶∆¶‡T¨¶‡T¶¶‡¶≈¶‡T—¶‡T¶" ""
	menu_item "2" "¶‡¶»¶‡T—¶‡T-¶‡T¨¶‡T¶¶‡¶≈¶‡T—¶‡T¶" ""
	if is_installed; then
		menu_item "3" "¶‡¶Œ¶·Ú¿⁄¶·¶¬¶‡T-¶·Ú¿⁄¶‡T¶¶‡T÷¶‡T—¶·¶œ: ¶‡TŸ¶‡T-¶·Ú¿⁄¶‡T¶¶‡T÷¶‡T’¶·¶¬¶‡T—¶‡T— (community)" ""
		menu_item "4" "¶‡T€¶‡T-¶‡¶≈¶‡T’¶‡¶∆¶‡T—¶·Ú¿⁄¶·¶  ¶‡¶∆¶·¶√¶‡T¶ ¶·¶√¶‡T◊¶‡T—¶·¶√¶‡T‘¶‡T—" ""
		menu_item "5" "¶‡T‡¶‡T¶¶‡T—¶‡T-¶‡T‘¶·Ú¿⁄¶‡T—¶·¶¬¶‡T’¶‡¶∆¶‡T-¶·Ú¿⁄¶·¶  ¶‡T‘¶‡T-¶·Ú¿⁄¶‡T¶¶‡T÷¶‡T’¶·¶¬¶‡T—¶‡T—" ""
		menu_item "6" "¶‡Tﬂ¶‡T’¶‡T—¶‡T-¶‡T’¶·¶¬ ¶·¶√¶·Ú¿⁄¶·¶¬¶‡T-¶·Ú¿⁄¶‡T¶¶‡T÷¶‡T—¶‡Úƒ÷ (¶‡T‘¶‡T-¶‡T‘ magisk)" ""
		menu_item "7" "¶‡Ú¿‘¶‡T-¶‡T◊¶·T”¶·¶√¶·Ú¿⁄¶‡T—¶·Ú¿⁄¶·¶  blockcheck2 (¶‡T—¶‡¶≈¶·Ú¿⁄¶‡T¶¶·¶¬¶‡T-¶‡T‘¶·Ú¿⁄¶‡T—¶‡¶∆¶‡¶≈¶‡T’)" ""
		menu_item "8" "¶‡Tﬁ¶‡T¶¶·¶√¶·Ú¿⁄ ¶·¶√¶·Ú¿⁄¶·¶¬¶‡T-¶·Ú¿⁄¶‡T¶¶‡T÷¶‡T—¶‡Úƒ÷ (¶‡T-¶‡¶∆¶·Ú¿⁄¶‡T’)" ""
		menu_item "9" "¶‡T€¶‡T-¶‡¶≈¶‡T’¶‡¶∆¶‡T—¶·Ú¿⁄¶·¶  ¶·¶√¶‡T◊¶‡T—¶·¶√¶‡T’¶‡T‘ RKN" ""
		menu_item "10" "¶‡Ú¿Ÿ¶‡T‘¶‡T¨/¶‡Ú¿Ÿ¶·Ú¿¶¶‡T‘¶‡T¨ NFQWS2" ""
		menu_item "11" "¶‡Tﬂ¶‡T¶¶·¶¬¶‡T¶¶‡T¨¶‡T-¶‡T◊¶·T”¶·¶√¶‡T‘ ¶·¶√¶‡T¶¶·¶¬¶‡¶∆¶‡T—¶·¶√¶‡T-" ""
		menu_item "12" "¶‡Tﬂ¶‡T’¶‡T‘¶‡T-¶‡T¨¶‡T-¶·Ú¿⁄¶·¶  ¶·¶√¶·Ú¿⁄¶‡T-¶·Ú¿⁄¶·T”¶·¶√" ""
		menu_item "13" "¶‡Tﬂ¶‡T’¶‡T‘¶‡T-¶‡T¨¶‡T-¶·Ú¿⁄¶·¶  ¶·¶√¶·Ú¿⁄¶·¶¬¶‡T-¶·Ú¿⁄¶‡T¶¶‡T÷¶‡T—¶‡T— ¶‡T‘¶‡T-¶·Ú¿⁄¶‡T¶¶‡T÷¶‡T’¶·¶¬¶‡T—¶‡Úƒ÷" ""
		menu_item "14" "¶‡Tﬂ¶‡T’¶‡T‘¶‡T-¶‡T¨¶‡T-¶·Ú¿⁄¶·¶  NFQWS2_OPT (¶‡T‘¶‡T-¶·Ú¿⁄¶‡T¶¶‡T÷¶‡T’¶·¶¬¶‡T—¶‡T—)" ""
		menu_item "15" "¶‡T‡¶‡T¶¶‡T—¶‡T-¶‡T‘¶·Ú¿⁄¶‡T—¶·¶¬¶‡T’¶‡¶∆¶‡T-¶·Ú¿⁄¶·¶  config" ""
	fi
	menu_item "0" "¶‡Ú¿Ÿ¶·Ú¿¶¶·Ú¿Ê¶‡T’¶‡T—" ""
	echo ""
	read_tty "¶‡Ú¿Ÿ¶‡T-¶·Ú¬Ï ¶‡¶∆¶·Ú¿¶¶‡T-¶‡T’¶·¶¬: " ans
	...
	case "$ans" in
		...
		0|"") exit 0 ;;
		*) echo -e "${yellow}¶‡T‹¶‡T¶¶‡¶∆¶‡T¶¶·¶¬¶‡¶≈¶·Ú¿¶¶‡Úƒ÷ ¶‡¶∆¶‡¶∆¶‡T’¶‡T—.${plain}"; sleep 1 ;;
	esac
